...
/*!50013 DEFINER=`mmg`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_orders` AS select 1 AS `oredrid`,1 AS `custid`,1 AS `name`,1 AS `bookid`,1 AS `bookname`,1 AS `saleprice`,1 AS `orderdate` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`mmg`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `vorders` AS select 1 AS `orderid`,1 AS `custid`,1 AS `name`,1 AS `bookid`,1 AS `bookname`,1 AS `saleprice`,1 AS `orderdate` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
